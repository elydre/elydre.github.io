...
Une fois le jeu lancé, vous pouvez accéder au option et choisir le `Français (Canada)` comme langue. Dans Paramètres graphiques, vous pouvez baisser la qualité, la distance de rendu, etc de pour de meilleure performance.<br>
